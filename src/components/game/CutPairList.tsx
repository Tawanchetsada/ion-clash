...
/**
 * รายการข้อความของคู่ไอออนตัวประกอบที่ตัดแล้ว — คู่กับเส้นตัด SVG ของ Phase 6 เสมอ
 * ตามข้อบังคับ a11y "เส้นตัดไอออนตัวประกอบต้องมีรายการข้อความควบคู่ไปกับเส้น SVG"
 */
