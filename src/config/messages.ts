...
export const MESSAGES = {
  ...
  success: {
    ...
    cancelPair: "ตัดไอออนตัวประกอบคู่นี้ถูกต้อง",
    cancelComplete: "ตัดไอออนตัวประกอบครบแล้ว",
  ...
  ui: {
    ...
    cutPairEmpty: "ยังไม่ได้ตัดไอออนตัวประกอบคู่ใด",
    cutPairListLabel: "รายการไอออนตัวประกอบที่ตัดแล้ว",
