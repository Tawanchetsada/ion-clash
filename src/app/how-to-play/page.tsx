    ...
    <PageShell>
      ...
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col items-center justify-center px-4 py-12 text-center">
        <div className="max-w-md rounded-card bg-white p-8 shadow-card border border-border">
          <span
            aria-hidden="true"
            className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-blue/10 text-2xl font-bold text-blue"
          >
            📖
          </span>
          <h1 className="text-2xl font-bold text-navy">วิธีการเล่น</h1>
          <p className="mt-2 text-sm text-navy/70">
            คู่มือการเล่นและการใช้งานระบบลาก-วางกำลังอยู่ระหว่างการจัดทำเนื้อหา (Phase 8)
          </p>
          <div className="mt-6">
            <Link
              href="/levels"
