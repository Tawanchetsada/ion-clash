...
function buildDocument(): string {
  return [
    ...
    "",
    "### 2. ระดับความยากของด่าน 28 และ 29",
    "",
    "ด่าน 28 (Ca(NO3)2 + Na2CO3) และ 29 (Ba(NO3)2 + Na2CO3) มีความซับซ้อนทางคณิตศาสตร์",
    "เท่ากับด่าน 15-17 ทุกประการ คือประจุ ±2 อัตราส่วน 1:1:1:2 และสูตรตะกอนไม่มีวงเล็บ",
    "แต่ถูกจัดเป็น `medium` ขณะที่ด่าน 15-17 เป็น `basic`",
    "",
    "เหตุผลคือหน้าเลือกด่านในเว็บแบ่งกลุ่มตามช่วงเลขด่านกลุ่มละ 10 ด่านเป๊ะ (01-10 ง่าย,",
    "11-20 พื้นฐาน, 21-30 ปานกลาง, 31-40 ยาก, 41-50 ท้าทาย) ระดับความยากจึงเป็นป้ายบอก",
    "ตำแหน่งในลำดับการเรียน ไม่ใช่ค่าที่วัดจากความยากของตัวเลข",
    "",
    "**คำถาม:** ยอมรับการจัดแบบนี้ได้หรือไม่ หรือต้องการสลับด่าน 28-29 กับด่านอื่นในช่วง 21-30",
    "เพื่อให้ความยากไล่ระดับสมจริงกว่านี้",
    "",
    "ผลตรวจ: [ ] รับได้ตามนี้ · [ ] ขอให้สลับ (ระบุ: ______________________)",
    "",
    "---",
    "",
